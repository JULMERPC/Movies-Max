...
import com.puma.videomax.presentation.components.VideoListItem
		...
		when (action) {
			...
			is VideoMenuAction.PlayBackground -> {
				...
				scope.launch {
					...
					if (video != null) {
						val serviceIntent = Intent(context, com.puma.videomax.service.BackgroundAudioService::class.java).apply {
							putExtra(com.puma.videomax.service.BackgroundAudioService.EXTRA_VIDEO_URI, video.uri)
							putExtra(com.puma.videomax.service.BackgroundAudioService.EXTRA_VIDEO_NAME, video.displayName)
							putExtra(com.puma.videomax.service.BackgroundAudioService.EXTRA_VIDEO_ID, video.id)
							putExtra(com.puma.videomax.service.BackgroundAudioService.EXTRA_AUTO_PLAY_NEXT, viewModel.autoPlayNext())
						}
