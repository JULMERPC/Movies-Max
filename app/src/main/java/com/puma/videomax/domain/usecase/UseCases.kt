...
class ToggleFavoriteUseCase @Inject constructor(
	private val favoritesRepository: com.puma.videomax.domain.repository.FavoritesRepository
) {
...
class ObserveHistoryUseCase @Inject constructor(
	private val historyRepository: com.puma.videomax.domain.repository.HistoryRepository
) {
...
class ObservePlaylistsUseCase @Inject constructor(
	private val playlistRepository: com.puma.videomax.domain.repository.PlaylistRepository
) {
